...
// import dashboard
import '../../dashboard/super_admin/views/super_admin_dashboard.dart';

// import dashboard provider
import '../../dashboard/super_admin/viewmodels/dashboard_provider.dart';
                ...
                return Expanded(
                  child: GestureDetector(
                    ...
                    onTap: () {
                      ...
                      if (index == 0) {
                        context.read<DashboardProvider>().getStats();
                      }
