...
class _EditAdminPageState extends State<EditAdminPage> {
  ...
  Widget build(BuildContext context) {
    final String adminName = widget.admin["name"]?.toString() ?? "Admin";

    final String adminEmail = widget.admin["email"]?.toString() ?? "-";
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            // PROFILE HEADER
            // ==================================================
            _buildAdminHeader(adminName: adminName, adminEmail: adminEmail),
            ...
            const Text(
              "Perbarui informasi dasar akun admin.",
  ...
  Future<String?> _showResetPasswordDialog(BuildContext context) async {
    return showDialog<String>(
      ...
      builder: (_) {
        return _ResetPasswordDialog(admin: widget.admin);
      },
    );
  }
